...
if __name__ == '__main__':
  ...
  while episode <= MAX_EPISODES:
      ...
      if done or truncated:
          ...
          if episode % 250 == 0:
            agent.save_models(episode, 'Models/Duel/')
            print('Evaluating model..')
            res = evaluate_model(episode, 'DuelDQN')
  ...
  f.savefig('Figures/DuelDQN_training.pdf', bbox_inches='tight')
  ...
  f.savefig('Figures/DuelDQN_training_eval_return.pdf', bbox_inches='tight')
